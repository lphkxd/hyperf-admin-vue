<template>
  <el-table
    ...
    <el-table-column type="expand">
      <div slot-scope="props" class="cs-error-log__expand-group">
        <expand-item
          :type="props.row.type"
          title="类型"
        ...
        <expand-item
          :type="props.row.type"
          title="账号昵称"
          :value="get(props.row.user, 'nickname', '')"/>
        <expand-item
          :type="props.row.type"
          title="uuid"
...
import ExpandItem from './components/expand-item'
...
<style lang="scss">
  ...
  .cs-error-log__expand-group {
    .cs-error-log__expand {
      padding-left: 20px;
      margin-bottom: 10px;
      &:last-child {
        margin-bottom: 0px;
      }
      .cs-error-log__expand-title {
        font-size: 16px;
        font-weight: bold;
        margin-top: 0px;
        margin-bottom: 10px;
      }
      .cs-error-log__expand-value {
        font-size: 12px;
        margin-top: 0px;
        margin-bottom: 0px;
      }
    }
    .cs-error-log__expand--log {
      border-left: 4px solid $color-info;
    }
    .cs-error-log__expand--error {
