  ...
  mutations: {
    ...
    open(state, { name, params, query }) {
      ...
      if (pageOpend) {
        ...
        this.commit('careyshop/page/openedUpdate', {
        ...
        if (page) {
          this.commit('careyshop/page/add', {
            tag: page,
            params,
            query
          })
      ...
      this.commit('careyshop/page/currentSet', name)
    },
    /**
     * @class current
    ...
    openedUpdate(state, { index, params, query }) {
      ...
      // 持久化
      this.commit('careyshop/page/opencsdb')
    },
    /**
    ...
    async openedLoad(state) {
      // store 赋值
      const value = await this.dispatch('careyshop/db/get', {
        dbName: 'sys',
        path: 'page.opened',
