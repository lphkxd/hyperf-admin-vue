<template>
  <div class="cs-theme-header-menu" ref="page" :class="{'is-scrollable': isScroll}" flex="cross:center">
    <div class="cs-theme-header-menu__content" ref="content" flex-box="1" flex>
      <div class="cs-theme-header-menu__scroll" ref="scroll" flex-box="0" :style="'transform: translateX(' + currentTranslateX + 'px);'">
    ...
    <div v-if="isScroll" class="cs-theme-header-menu__prev" flex-box="0" @click="scroll('left')" flex="main:center cross:center">
      <i class="el-icon-arrow-left"></i>
    </div>
    <div v-if="isScroll" class="cs-theme-header-menu__next" flex-box="0" @click="scroll('right')" flex="cross:center">
